...
export default function Cancer () {
    return (
        <div className='content'>
            <div>
                <h1>Unit 1- Biology of Cancer</h1>
                <h6>Cancer</h6>
                    <p>
                    Cancer is desease that is caused by inability of the body to control the division of cells
                    When cells inappropriately multiply, why?
                     <ul>
                        <li>Mutation</li>
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li>Carcinoma- lining of the internal organs or skin</li>
                        <li></li>
                    </ul>
                </div>
